...
const Footer = () => {
  ...
  const LinkItems = [
    ...
    // const parallax = () => {
    //     const parallaxEls = document.getElementsById('footerContent');
    //     const speed = 0.4;
    ...
    //         const shift = speed * parallaxEls.getBoundingClientRect().bottom;
    ...
    useEffect(() => {
        ...
        const translateFooter = () => {
          const footerOffset = footerEl.getBoundingClientRect().bottom;
          const divisor=1500;

          console.log(footerOffset)

          footerEl.style.transform = footerOffset <800
                                    ? 'translate3d(0px, ' +  -1*(footerOffset/divisor) + '%, (divisor/footerOffset)*100 %)'
    ...
    <div className='footerContent'  id="footerContent">
      <div className='QuotesContainer'>
        ...
        <div className='LogoContainer'>
            ...
            <img src={logo} style={{width:"400px",filter:"invert(100%)"}}></img>
        </div>
    ...
    <div className='footerItems'>
        ...
        <div>
            ...
            { LinkItems.map(val=>{
              ...
              if(val.linkCount <=3) {
                return <LinkComponent key={val.linkName} {...val}/>
              }
            })
            }
